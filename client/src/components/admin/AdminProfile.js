...
// ✅ เอา FaQuoteLeft (ไอคอนของ Bio) ออกแล้ว
import { FaUser, FaPhone, FaVenusMars, FaCamera, FaInfoCircle, FaUserShield } from 'react-icons/fa';

import './AdminProfile.css';

const AdminProfile = () => {
    const [profile, setProfile] = useState({
        fullname: '', phone: '', gender: '', profile_image: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setMessage({ type: 'success', text: 'บันทึกการเปลี่ยนแปลงข้อมูลผู้ดูแลระบบเรียบร้อยแล้ว' });
            fetchProfile(); 
        } catch (err) {
    ...
    if (loading) return (
        <div className="text-center py-5">
            ...
            <div className="mt-3 fw-bold text-primary">กำลังโหลดข้อมูลบัญชี...</div>
        </div>
    );
        ...
        <div className="fade-in-up">
            ...
            <div className="header-brand-border">
                <h2 className="fw-bold pcshs-navy m-0 display-6">
                    <FaUserShield className="me-3 text-warning" /> 
                    จัดการโปรไฟล์ผู้ดูแลระบบ
                </h2>
                <p className="text-muted small mb-0 mt-2">ปรับปรุงข้อมูลส่วนตัวและตัวตนสำหรับสิทธิ์ Admin</p>
            </div>
                    ...
                    <Form onSubmit={handleSubmit}>
                        <Row className="align-items-start">
                            ...
                            <Col lg={4} className="text-center mb-5 mb-lg-0">
                                ...
                                <div className="mt-4">
                                    <span className="badge-role bg-dark text-white border-0">System Administrator</span>
                                </div>
                            </Col>
                            ...
                            <Col lg={8}>
                                <div className="mb-4 pb-2 border-bottom">
                                    <h5 className="fw-bold text-dark mb-1">ข้อมูลส่วนตัวผู้ดูแลระบบ</h5>
                                </div>
