...
import './PCSHSNavbar.css';

// --- นำเข้า Profile Modal ---
...
const PCSHSNavbar = () => {
    ...
    // --- State สำหรับคุมการแสดงผล Profile Modal ---
                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ms-auto align-items-center gap-2">
                            ...
                            <Dropdown align="end">
                                <Dropdown.Toggle variant="light" className="rounded-pill btn-sm d-flex align-items-center gap-2 border bg-white text-dark py-1 px-3 ms-2 shadow-sm">
